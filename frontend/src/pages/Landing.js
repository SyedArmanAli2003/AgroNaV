    ...
    <>
      ...
      <div className="content-layer">
        ...
        <div style={{ maxWidth: '1200px', margin: '80px auto 40px auto', padding: '0 24px', display: 'flex', flexDirection: 'column', gap: '96px', fontFamily: "'Poppins', sans-serif" }}>
          ...
          <section id="features" style={{ scrollMarginTop: '40px' }}>
            ...
            <div className="features-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
              ...
              <div id="nba-section" className="liquid-glass-strong" style={{ borderRadius: 'var(--radius-lg)', padding: '32px 24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <p style={{ fontSize: '14px', color: 'var(--text-secondary)', lineHeight: 1.6, margin: 0 }}>
                  At every outlet, the app tells you what product to recommend, what to say, and why — generated by our multi-model AI engine from live inventory, crop stage, and pest alerts in your district.
                </p>
              </div>
          ...
          <section id="about" style={{ scrollMarginTop: '40px' }}>
            <div className="about-cols" style={{ display: 'flex', gap: '48px', alignItems: 'center' }}>
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <p style={{ fontSize: '14px', color: 'var(--text-secondary)', lineHeight: 1.6, margin: 0 }}>
                  The system combines CatBoost (AUC 0.79) and XGBoost ML models trained on real Syngenta visit data, SHAP-powered explanations, multi-model AI coaching advice, and a Manager portal — all working together so field reps make smarter, data-driven visits.
                </p>
              ...
              <div className="stats-grid" style={{ flex: 1, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                ...
                <div className="liquid-glass-strong" style={{ borderRadius: 'var(--radius-md)', padding: '24px', textAlign: 'center' }}>
                  <div style={{ fontSize: '22px', fontWeight: 700, color: '#4ECDC4' }}>LLM Stack</div>
                  <div style={{ fontSize: '12px', color: 'var(--text-muted)', marginTop: '4px' }}>Multi-AI NBA Engine</div>
                </div>
              </div>
            </div>
          </section>
          ...
          <section id="how-to-use" style={{ scrollMarginTop: '40px' }}>
            <div style={{ textAlign: 'center', marginBottom: '48px' }}>
              <span style={{ fontSize: '12px', textTransform: 'uppercase', letterSpacing: '2px', color: 'var(--color-primary, #1D9E75)', fontWeight: 600 }}>User Guide</span>
              <h2 style={{ fontSize: 'clamp(28px, 4vw, 38px)', fontWeight: 600, color: 'var(--text-primary)', marginTop: '8px', marginBottom: '8px' }}>How to use AgroNav</h2>
